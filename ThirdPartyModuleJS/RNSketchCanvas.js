...
import SketchCanvas from './src/RNSketchCanvas/SketchCanvas';
import { requestPermissions } from './src/RNSketchCanvas/handlePermissions';
    ...
    render() {
        return (
            <View style={this.props.containerStyle}>
                <View style={[{ flexDirection: 'row' }, this.props.headerContainerStyle]}>
