package com.rnvideochat.rssignaturecapture;
...
import com.rnvideochat.rssignaturecapture.RSSignatureCaptureContextModule;
...
public class RSSignatureCaptureViewManager extends ViewGroupManager<RSSignatureCaptureMainView> {
    ...
    public Map<String, Integer> getCommandsMap() {
        ...
        return MapBuilder.of("saveImage", COMMAND_SAVE_IMAGE, "resetImage", COMMAND_RESET_IMAGE);
    }

    @Override
    public void receiveCommand(RSSignatureCaptureMainView view, int commandType, @Nullable ReadableArray args) {
