...
import {AssetColor} from '../../components/Config';
                ...
                <View style={{flex: 0.4}}>
                  <View style={{flex: 1, alignItems: 'center'}}>
                    <Text style={{color: 'green'}}>
                      Congratulations Your Booking has
                    </Text>
                    <Text style={{color: 'green'}}>been confirmed</Text>
                  </View>

                  <View style={{flex: 1, alignItems: 'center'}}>
                    <Text style={{color: AssetColor}}>
                      Booking reference number
                    </Text>
                    <Text style={{color: AssetColor}}>87334</Text>
                  </View>
                  ...
                  <View style={{flex: 1, alignItems: 'center'}}>
                    ...
                    <Text style={{color: 'green'}}>
                      message ahead of your appointment
                    </Text>
                  </View>
                </View>
                {/* <View style={{flex: 0.5}}>
